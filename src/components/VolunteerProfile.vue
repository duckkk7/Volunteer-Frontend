  ...
  <div class="profile-for-volunteers">
    <div class="profile-container">
      ...
      <div class="profile-content">
        ...
        <button class="edit-btn" @click="$router.push('/volunteer-profile/edit')">Редактировать профиль</button>
        ...
        <div class="invitations">
          ...
          <div v-for="invitation in invitations" :key="invitation.invitationId">
            ...
            <button @click="acceptInvitation(invitation.invitationId)">Вступить в организацию</button>
          </div>
        </div>
