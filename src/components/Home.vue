...
<!--  </head>-->
<!--  <body>-->
<!--  &lt;!&ndash; Шапка. Это у тебя уже есть. &ndash;&gt;-->
<!--  <header>-->
<!--    <div class="head__con">-->
<!--      <div class="main__menu">-->
<!--        <a class="menu__item" href="#">О нас</a>-->
<!--        <a class="menu__item" href="#">Волонтерам</a>-->
<!--        <a class="menu__item" href="#">Мероприятия</a>-->
<!--        <a class="menu__item" href="#">Ещё</a>-->
<!--      </div>-->
<!--      <div class="btn__con">-->
<!--        <a class="head__signIn" href="#">Войти</a>-->
<!--        <a class="head__logIn" href="#">Зарегистрироваться</a>-->
<!--      </div>-->
<!--    </div>-->
<!--  </header>-->
<!--  <main>-->
...
<!--            <img src="/vol-reg-picture.png" alt="img">-->
<!--            <div class="event__info">-->
<!--              <div class="info__title">Общегородская мемориально-патронатная акция (июнь 2024)</div>-->
<!--              <div class="info__org">Комитет общественных связей и молодежной политики г. Москвы</div>-->
...
<!--        <div class="foot__text__1"><b>Подпишитесь на наши обновления</b><br>Чтобы оставаться в курсе последних событий</div>-->
<!--      </div>-->
<!--      <div class="foot__right">-->
<!--        <div class="foot__contact">-->
<!--          <input placeholder="Введите e-mail" type="text">-->
<!--          <a class="foot__btn" href="#">Подписаться</a>-->
<!--        </div>-->
<!--        <div class="foot__copy">Нажимая кнопку “подписаться” вы даете согласие  на обработку ваших персональных данных</div>-->
<!--      </div>-->
<!--    </div>-->
<!--  </footer>-->
<!--  </body>-->
...
<!--  display: flex; /* Выравнивание по экрану. Здесь в строку. */-->
<!--  justify-content: space-between; /* Распределить элементы по ширине */-->
<!--  align-items: baseline; /* Выровнять элементы по горизонтали */-->
<!--  padding: 5% 10%;-->
<!--}-->
